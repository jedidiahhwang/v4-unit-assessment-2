...
for (let i = 0; i < classes.length; i++) {
    for (let key in classes) {
          for (let prop in classes[key]) {
            if (typeof classes[key][prop] === "boolean")
...
//CODE HERE
  let phone1 = new Phone ("Apple", "iPhone 12", 128, "Graphite", false);
  
  let phone2 = new Phone ("Google", "Pixel 5", 64, "White", false);
  
  let phone3 = new Phone ("Samsung", "Galaxy S20", 256, "Blue", false);
